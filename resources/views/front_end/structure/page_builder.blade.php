                ...
                @if (isset($allData->pageBuilderContent) && !empty($allData->pageBuilderContent) && isset($device))
                    @foreach ($allData->pageBuilderContent as $pgd)
                        ...
                        @if ($pgd->builder_type == 'EFORM' && $pgd->position == 'RIGHT')
                            ...
                            @if (url()->current() == 'https://www.multotec.com/en/location/north-america/multotec-canada')
    <p style="text-align:center;">
        <strong style="font-size:24px;vertical-align:middle;">Follow us:</strong>
        <a href="#"><img src="/public/uploads/files/youtube.jpg" width="50" height="50" style="vertical-align:middle;"></a>
        <a href="#"><img src="/public/uploads/files/linkedin.jpg" width="50" height="50" style="vertical-align:middle;"></a>
        <a href="#"><img src="/public/uploads/files/facebook.jpg" width="50" height="50" style="vertical-align:middle;"></a>
        <a href="#"><img src="/public/uploads/files/twitter.png" width="50" height="50" style="vertical-align:middle;"></a>
    </p>
@endif
                                <!-- For Desktop Popup -->
