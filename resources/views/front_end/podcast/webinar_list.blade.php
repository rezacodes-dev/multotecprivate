...
<a href="{{ route('front.podcastContent', array('lng' => $lng, 'id' => $v->slug)) }}" > 
@php
$imageURL='';
...
<li><a href="{{ route('front.podcastContent', array('lng' => $lng, 'id' => $v->slug)) }}" >Watch Podcast</a></li> 
