    ...
    $regionname=DB::table('event_management_continents')->select('id','continent_name')->get();
      ...
      <div class="select-container ">
        ...
        @endif
          ...
          {{-- <input class="btn btn-primary pl-5" type="submit" name="Submit" value="Filter"> --}}
          <a class="btn btn-primary pl-5" href="{{ route('eventListsen') }}" >Clear</a>
...
<div class="picinner">    
    ...
    $imageURL='';                                    
        ...
        <a  class="inner_img" href="{{ route('eventDetails', array( 'id' => $v->slug)) }}">
            <img src="{{$imageURL}}"  >
        </a>
        @else
    <a href="{{ route('eventDetails', ['id' => $v->slug]) }}">
        <img class="inner_img" src="{{ asset('public/images/default_multotec.jpg') }}">
    </a>
        @endif
...
<a href="" > 
  ...
  $countryname=DB::table('event_management_countries')->where('id',$v->country_id)->select('country_name')->first();
        ...
        @else
           <a href class="inner_img" ="{{ route('eventDetails', array( 'id' => $v->slug)) }}">
