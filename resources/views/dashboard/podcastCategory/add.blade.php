...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="#">All Podcast Product</a></li>
    @if(isset($prodCat))
    <li class="active">Edit Podcast Product</li>
    @else
    <li class="active">Add Podcast Product</li>
    @endif
  </ol>
</section>
@endsection
...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-6">
      <a href="{{ route('allPdCt') }}" class="btn btn-primary"> All Podcast Product</a>
    ...
    <div class="col-md-12">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">@if(isset($prodCat)) Edit Podcast Product @else Add Podcast Product @endif</h3>
        ...
        <div class="box-body">
          <form name="jfrm" id="frmx" action="@if( isset($prodCat)){{ route('updatePdCt', array('id' => $content_id)) }}@else{{ route('savePdCt') }}@endif" method="post" enctype="multipart/form-data">
          {{ csrf_field() }}
          ...
          <div class="row">
            <div class="col-md-10">
              <div class="form-group">
                <label>Podcast Product : <em>*</em></label>
                <input type="text" name="name" id="scName" class="form-control" placeholder="Enter Podcast Product" value="@if( isset($prodCat) ){{ $prodCat->name }}@endif">
              </div>
...
fm.validate({
  ...
  messages: {
    ...
    name: {
      required: 'Please Enter Product or Subcategory Name.'
    },
    slug: {
