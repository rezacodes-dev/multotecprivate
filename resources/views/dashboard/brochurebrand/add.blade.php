...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="{{ route('allBrbrandId') }}">All Brochure brand</a></li>
    @if(isset($prodCat))
    <li class="active">Edit Brochure brand</li>
    @else
    <li class="active">Add Brochure brand</li>
    @endif
  </ol>
</section>
@endsection
...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-6">
      <a href="{{ route('allBrbrandId') }}" class="btn btn-primary"> All Brochure Type</a>
    ...
    <div class="col-md-12">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">@if(isset($prodCat)) Edit Brochure Brand @else Add Brochure Brand @endif</h3>
        ...
        <div class="box-body">
          <form name="jfrm" id="frmx" action="@if( isset($prodCat)){{ route('updateBrbrandId', array('id' => $content_id)) }}@else{{ route('saveBrbrandId') }}@endif" method="post" enctype="multipart/form-data">
          {{ csrf_field() }}
          ...
          <div class="row">
            <div class="col-md-10">
              <div class="form-group">
                <label>Brochure Brand : <em>*</em></label>
                <input type="text" name="name" id="scName" class="form-control" placeholder="Enter Brochure Brand" value="@if( isset($prodCat) ){{ $prodCat->name }}@endif">
              </div>
