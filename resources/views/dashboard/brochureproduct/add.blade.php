...
<section class="content-header">
  <h1>
    @if(isset($prodCat))
    Edit Brochure Product
    @else
    Add Brochure Product
    @endif
    <!--small>it all starts here</small-->
  </h1>
  <ol class="breadcrumb">
    <li><a href="{{ route('dashboard') }}"><i class="fa fa-dashboard"></i> Home</a></li>
    <li><a href="{{ route('allBrprId') }}">All Brochure Product</a></li>
    @if(isset($prodCat))
    <li class="active">Edit Brochure Product</li>
    @else
    <li class="active">Add Brochure Product</li>
    @endif
  </ol>
</section>
@endsection
...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-6">
      <a href="{{ route('allBrprId') }}" class="btn btn-primary"> All Brochure Product</a>
    ...
    <div class="col-md-12">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">@if(isset($prodCat)) Edit Brochure Product @else Add Brochure Product @endif</h3>
        ...
        <div class="box-body">
          <form name="jfrm" id="frmx" action="@if( isset($prodCat)){{ route('updateBrprId', array('id' => $content_id)) }}@else{{ route('saveBrprId') }}@endif" method="post" enctype="multipart/form-data">
          {{ csrf_field() }}
          ...
          <div class="row">
            <div class="col-md-10">
              <div class="form-group">
                <label>Brochure Product : <em>*</em></label>
                <input type="text" name="name" id="scName" class="form-control" placeholder="Enter Brochure Product" value="@if( isset($prodCat) ){{ $prodCat->name }}@endif">
              </div>
