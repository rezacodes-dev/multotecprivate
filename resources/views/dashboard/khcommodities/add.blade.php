...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="#">All  Commodities</a></li>
    @if(isset($prodCat))
    <li class="active">Edit  Commodities</li>
    @else
    <li class="active">Add  Commodities</li>
    @endif
  </ol>
</section>
@endsection
...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-6">
      <a href="{{ route('allKhcolgId') }}" class="btn btn-primary"> All  Commodities</a>
    ...
    <div class="col-md-12">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">@if(isset($prodCat)) Edit  Commodities @else Add  Commodities @endif</h3>
        ...
        <div class="box-body">
          <form name="jfrm" id="frmx" action="@if( isset($prodCat)){{ route('updateKhcolgId', array('id' => $content_id)) }}@else{{ route('saveKhcolgId') }}@endif" method="post" enctype="multipart/form-data">
          {{ csrf_field() }}
          ...
          <div class="row">
            <div class="col-md-10">
              <div class="form-group">
                <label> Commodities : <em>*</em></label>
                <input type="text" name="name" id="scName" class="form-control" placeholder="Enter  Commodities" value="@if( isset($prodCat) ){{ $prodCat->name }}@endif">
              </div>
