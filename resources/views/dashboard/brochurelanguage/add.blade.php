...
<section class="content-header">
  <h1>
    @if(isset($prodCat))
    Edit Brochure language
    @else
    Add Brochure language
    @endif
    <!--small>it all starts here</small-->
  </h1>
  <ol class="breadcrumb">
    <li><a href="{{ route('dashboard') }}"><i class="fa fa-dashboard"></i> Home</a></li>
    <li><a href="{{ route('prodCats') }}">All Brochure language</a></li>
    @if(isset($prodCat))
    <li class="active">Edit Brochure language</li>
    @else
    <li class="active">Add Brochure language</li>
    @endif
  </ol>
</section>
@endsection
...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-6">
      <a href="{{ route('allBrlgId') }}" class="btn btn-primary"> All Brochure Language</a>
    ...
    <div class="col-md-12">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">@if(isset($prodCat)) Edit Brochure Language @else Add Brochure Language @endif</h3>
        ...
        <div class="box-body">
          <form name="jfrm" id="frmx" action="@if( isset($prodCat)){{ route('updateBrlgId', array('id' => $content_id)) }}@else{{ route('saveBrlgId') }}@endif" method="post" enctype="multipart/form-data">
          {{ csrf_field() }}
          ...
          <div class="row">
            <div class="col-md-10">
              <div class="form-group">
                <label>Brochure Language : <em>*</em></label>
                <input type="text" name="name" id="scName" class="form-control" placeholder="Enter Brochure Language" value="@if( isset($prodCat) ){{ $prodCat->name }}@endif">
              </div>
...
fm.validate({
  ...
  messages: {
    ...
    name: {
      required: 'Please Enter Topic or Subcategory Name.'
    },
    slug: {
