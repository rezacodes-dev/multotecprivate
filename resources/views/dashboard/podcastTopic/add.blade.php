...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="{{ route('prodCats') }}">All Podcast Topic</a></li>
    @if(isset($prodCat))
    <li class="active">Edit Podcast Topic</li>
    @else
    <li class="active">Add Podcast Topic</li>
    @endif
  </ol>
</section>
@endsection
...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-6">
      <a href="{{ route('allPdTp') }}" class="btn btn-primary"> All Podcast Topic</a>
    ...
    <div class="col-md-12">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">@if(isset($prodCat)) Edit Podcast Topic @else Add Podcast Topic @endif</h3>
        ...
        <div class="box-body">
          <form name="jfrm" id="frmx" action="@if( isset($prodCat)){{ route('updatePdTp', array('id' => $content_id)) }}@else{{ route('savePdTp') }}@endif" method="post" enctype="multipart/form-data">
          {{ csrf_field() }}
          ...
          <div class="row">
            <div class="col-md-10">
              <div class="form-group">
                <label>Podcast Topic : <em>*</em></label>
                <input type="text" name="name" id="scName" class="form-control" placeholder="Enter Podcast Topic" value="@if( isset($prodCat) ){{ $prodCat->name }}@endif">
              </div>
