...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-6">
      <a href="{{ route('allKhprlgId') }}" class="btn btn-primary"> All  Product</a>
    ...
    <div class="col-md-12">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">@if(isset($prodCat)) Edit  Product @else Add  Product @endif</h3>
        ...
        <div class="box-body">
          <form name="jfrm" id="frmx" action="@if( isset($prodCat)){{ route('updateKhprlgId', array('id' => $content_id)) }}@else{{ route('saveKhprlgId') }}@endif" method="post" enctype="multipart/form-data">
          {{ csrf_field() }}
          ...
          <div class="row">
            <div class="col-md-10">
              <div class="form-group">
                ...
                <input type="text" name="name" id="scName" class="form-control" placeholder="Enter  Product" value="@if( isset($prodCat) ){{ $prodCat->name }}@endif">
              </div>
