      ...
      <div class="box">
        ...
        <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <select name="language_id" id="language_id" class="form-control" style="width: 22%;">
                  @if( isset($languages) && !empty($languages) )
                    @foreach( $languages as $lng )
                      @if( $lng->id ==  $language_id )
    ...
    if( field_type == 'CHECKFIELD' ) {
      var fdHTML = '';
          ...
          fdHTML += '<div class="row">';
                fdHTML += '<div class="col-md-6">';
                  fdHTML += '<div class="form-group">';
                    fdHTML += '<label>Font : </label>';
                    fdHTML += '<input type="text" name="font" class="form-control" placeholder="Enter Font Family" />';
                  fdHTML += '</div>';
                fdHTML += '</div>';
                fdHTML += '<div class="col-md-6">';
                  fdHTML += '<div class="form-group">';
                    fdHTML += '<label>Size : </label>';
                    fdHTML += '<input type="text" name="size" class="form-control" placeholder="Enter size in px" />';
                  fdHTML += '</div>';
                fdHTML += '</div>';
              fdHTML += '</div>';
      ...
      $.ajax({
        ...
        success : function(modal_json_data) {
          ...
          if( ! jQuery.isEmptyObject(modal_json_data) ) {
            ...
            var font = obj.font === null ? '' : obj.font;
            ...
            if( fldType == 'CHECKFIELD' ) {
              ...
              fdHTML += '<div class="row">';
                fdHTML += '<div class="col-md-6">';
                  fdHTML += '<div class="form-group">';
                    fdHTML += '<label>Font : </label>';
                    fdHTML += '<input type="text" name="font" class="form-control" placeholder="Enter Font Family" value="'+ font +'" />';
                  fdHTML += '</div>';
                fdHTML += '</div>';
                fdHTML += '<div class="col-md-6">';
                  fdHTML += '<div class="form-group">';
                    fdHTML += '<label>Size : </label>';
                    fdHTML += '<input type="text" name="size" class="form-control" placeholder="Enter size in px" value="'+ size +'" />';
                  fdHTML += '</div>';
                fdHTML += '</div>';
              fdHTML += '</div>';
