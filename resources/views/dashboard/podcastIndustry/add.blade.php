...
<section class="content-header">
  <h1>
    @if(isset($prodCat))
    Edit Podcast Industry
    @else
    Add Podcast Industry
    @endif
    <!--small>it all starts here</small-->
  </h1>
  <ol class="breadcrumb">
    <li><a href="{{ route('dashboard') }}"><i class="fa fa-dashboard"></i> Home</a></li>
    <li><a href="#">All Podcast Industry</a></li>
    @if(isset($prodCat))
    <li class="active">Edit Podcast Industry</li>
    @else
    <li class="active">Add Podcast Industry</li>
    @endif
  </ol>
</section>
@endsection
...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-6">
      <a href="{{ route('allPdId') }}" class="btn btn-primary"> All Podcast Industry</a>
    ...
    <div class="col-md-12">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">@if(isset($prodCat)) Edit Podcast Industry @else Add Podcast Industry @endif</h3>
        ...
        <div class="box-body">
          <form name="jfrm" id="frmx" action="@if( isset($prodCat)){{ route('updatePdId', array('id' => $content_id)) }}@else{{ route('savePdId') }}@endif" method="post" enctype="multipart/form-data">
          {{ csrf_field() }}
          ...
          <div class="row">
            <div class="col-md-10">
              <div class="form-group">
                ...
                <input type="text" name="name" id="scName" class="form-control" placeholder="Enter Podcast Industry" value="@if( isset($prodCat) ){{ $prodCat->name }}@endif">
              </div>
