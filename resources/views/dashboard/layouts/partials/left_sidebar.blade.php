  ...
  <section class="sidebar">
      ...
      <li class="treeview @if(isset($GparentMenu) && $GparentMenu == 'contentManagement') active @endif">
        ...
        <ul class="treeview-menu">
          ...
          <li class="treeview @if(isset($parentMenu) && $parentMenu == 'Webinar') active @endif">
            ...
            <ul class="treeview-menu">
              <li class="@if(isset($childMenu) && $childMenu == 'webinar') active @endif">
                <a href="{{ route('allBrochureContent') }}"><i class="fa fa-circle-o"></i>Brochure List Page</a>
              </li>
    ...
    <li class="treeview @if(isset($parentMenu) && $parentMenu == '') active @endif">
      ...
      <li class="treeview @if(isset($parentMenu) && $parentMenu == 'Brochure') active @endif">
            ...
            <ul class="treeview-menu">
              <li class="@if(isset($childMenu) && $childMenu == 'allbrochures') active @endif">
                <a href="{{ route('allBrallId') }}"><i class="fa fa-circle-o"></i>All Brochures</a>
              </li>
              <li class="@if(isset($childMenu) && $childMenu == 'brochure_product') active @endif">
                <a href="{{ route('allBrprId') }}"><i class="fa fa-circle-o"></i>Brochure Product</a>
              </li>
              <li class="@if(isset($childMenu) && $childMenu == 'brochure') active @endif">
                <a href="{{ route('allBrlgId') }}"><i class="fa fa-circle-o"></i>Brochure Language</a>
              </li>
              <li class="@if(isset($childMenu) && $childMenu == 'brochuretype') active @endif">
                <a href="{{ route('allBrtyId') }}"><i class="fa fa-circle-o"></i>Brochure Type</a>
              </li>

              <li class="@if(isset($childMenu) && $childMenu == 'brochurebrand') active @endif">
                <a href="{{ route('allBrbrandId') }}"><i class="fa fa-circle-o"></i>Brochure Brand</a>
              </li>
