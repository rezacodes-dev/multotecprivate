...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    @if(isset($prodCat))
    <li class="active">Edit Brochure</li>
    @else
    <li class="active">Add Brochure</li>
    @endif
  </ol>
</section>
@endsection
  ...
  <div class="row" style="margin-top: 10px;">
    <div class="col-md-12">
      ...
      <div class="box">
        ...
        <div class="box-body">
          <form name="jfrm" id="frmx" action="@if( isset($prodCat)){{ route('updateBrochureContent', array('id' => $prodCat->id)) }}@endif" method="post" enctype="multipart/form-data">
          {{ csrf_field() }}
