...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="{{ route('allBrtyId') }}">All Brochure Size</a></li>
    @if(isset($prodCat))
    <li class="active">Edit Brochure Size</li>
    @else
    <li class="active">Add Brochure Size</li>
    @endif
  </ol>
</section>
@endsection
...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-6">
      <a href="{{ route('allBrtyId') }}" class="btn btn-primary"> All Brochure Size</a>
    ...
    <div class="col-md-12">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">@if(isset($prodCat)) Edit Brochure Size @else Add Brochure Size @endif</h3>
        ...
        <div class="box-body">
          <form name="jfrm" id="frmx" action="@if( isset($prodCat)){{ route('updateBrsiId', array('id' => $content_id)) }}@else{{ route('saveBrsiId') }}@endif" method="post" enctype="multipart/form-data">
          {{ csrf_field() }}
          ...
          <div class="row">
            <div class="col-md-10">
              <div class="form-group">
                <label>Brochure Size : <em>*</em></label>
                <input type="text" name="name" id="scName" class="form-control" placeholder="Enter Brochure Size" value="@if( isset($prodCat) ){{ $prodCat->name }}@endif">
              </div>
