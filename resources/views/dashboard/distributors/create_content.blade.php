      ...
      <div class="box">
        ...
        <div class="box-body">
          ...
          <!------------------------------------------------------------------------------------------------------->
            ...
            @php
                $fetchaddress=DB::table('branch_temp_contact')->where('branch_id',$content->id)->first();
              @endphp
                 <div class="form-group">
                <label>Address</label>
                <textarea name="page_address_content" id="pgConted" class="form-control">@if( isset($fetchaddress) ){{ html_entity_decode($fetchaddress->address_content, ENT_QUOTES) }}@endif</textarea>
              </div>
...
<script type="text/javascript">
var editor = CKEDITOR.replace( 'pgConted', {
  customConfig: "{{ asset('public/assets/ckeditor/maxi_config.js') }}",
} );
