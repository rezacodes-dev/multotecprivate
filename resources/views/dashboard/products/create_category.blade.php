...
<section class="content">
 ...
 <a href="{{ url('en/' . $prodCat->slug) }}" target="_blank" class="btn btn-primary">
    View Page
</a>
      @endif
    </div>
            ...
            <div class="col-md-10">
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                ...
                <input type="text" name="product_link" id="product_link" class="form-control" placeholder="Enter Page URL" value="@if( isset($prodCat) ){{ $prodCat->product_link??'' }}@endif">
               </div>
