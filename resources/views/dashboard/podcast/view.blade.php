...
<section class="content">
  ...
  <!-- <div class="row">
    <div class="col-md-6">
      <a href="{{ route('addPd') }}" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i> Create New Webinar</a>
    </div>
    <div class="col-md-6">
    </div>
  </div> -->
        ...
        @if(isset($allProdCats))
          ...
          <tr >
            ...
            <td>
             ...
             <a href="{{ route('delPdUser', array('id' => $pc->id)) }}" onclick="return confirm('Sure To Delete This Item ?');"><i class="fa fa-2x fa-trash-o base-red"></i></a>
