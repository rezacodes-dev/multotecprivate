...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="{{ route('prodCats') }}">All Podcast</a></li>
    @if(isset($prodCat))
    <li class="active">Edit Podcast</li>
    @else
    <li class="active">Add Podcast</li>
    @endif
  </ol>
</section>
@endsection
...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-6">
      <a href="{{ route('allPd') }}" class="btn btn-primary"> All Podcast</a>
    ...
    <div class="col-md-12">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">@if(isset($prodCat)) Edit Podcast @else Add Podcast @endif</h3>
        ...
        <div class="box-body">
          <form name="jfrm" id="frmx" action="@if( isset($prodCat)){{ route('updatePd', array('id' => $content_id)) }}@else{{ route('savePd') }}@endif" method="post" enctype="multipart/form-data">
          {{ csrf_field() }}
          ...
          @if( isset($prodCat) ) 
            ...
            <div class="col-md-10">
              <div class="form-group">
                <label>Podcast Name : <em>*</em></label>
                <input type="text" name="name" required id="name" class="form-control" placeholder="Enter Podcast Name " value="@if( isset($prodCat) ){{ $prodCat->name }}@endif">
              </div> 
              </div>
              ...
              <div class="col-md-10">
              <div class="form-group">
                <label>Podcast Slug : <em>*</em></label>
             ...
             <div class="col-md-10">
              <div class="form-group">
                <label>Podcast Type : <!-- <em>*</em> --></label>
                <select class="form-control" name="webinar_type" id="webinar_type">
                  <option value="">-Select Podcast Type-</option>
                  <option value="1" @if(isset($prodCat) && $prodCat->webinar_type=='1') selected @endif>Podcast Webinar</option>
              ...
              <div class="col-md-10">
              <div class="form-group">
                <label>Podcast Start Date : <em>*</em></label>
              ...
              <div class="col-md-10">
              <div class="form-group">
                <label>Podcast End Date : <em>*</em></label>
              ...
              <div class="form-group">
                ...
                <input type="text" name="duration" id="duration" class="form-control" placeholder="Enter Podcast Duration " value="@if( isset($prodCat) ){{ $prodCat->duration }}@endif">
              </div> 
              </div>            
              ...
              <div class="col-md-10">
              <div class="form-group">
                <label>Podcast Product(s) : <em>*</em></label> 
                <select name="webinar_category[]" required class="form-control" multiple>
                  <option value="">-Select Podcast Product-</option>
              ...
              <div class="col-md-10">
              <div class="form-group">
                <label>Podcast Topic(s) : <em>*</em></label> 
                <select name="webinar_topic[]" required class="form-control" multiple>
                  <option value="">-Select Podcast Topic-</option>
...
$topic=explode(',',$prodCat->webinar_topic);
              ...
              <div class="col-md-10">
              <div class="form-group">
                <label>Podcast Industry  : <em>*</em></label> 
                <select name="webinar_industry[]" required class="form-control" multiple>
                  <option value="">-Select Podcast Industry-</option>
