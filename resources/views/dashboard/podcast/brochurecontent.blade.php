  ...
  <div class="row" style="margin-top: 10px;">
    <div class="col-md-12">
      ...
      <div class="box">
        ...
        <div class="box-body">
          <form name="jfrm" id="frmx" action="@if( isset($prodCat)){{ route('updatePodcastContent', array('id' => $prodCat->id)) }}@endif" method="post" enctype="multipart/form-data">
          {{ csrf_field() }}
          ...
          <div class="row">
            ...
            <div class="col-md-10">
              <div class="form-group">
                <label>H1 : <em>*</em></label>
                <input type="text" name="heading" required id="scName" class="form-control" placeholder="Enter Heading " value="@if( isset($prodCat) ){{ $prodCat->heading }}@endif">
              </div> 
              </div>
              ...
              <div class="form-group">
                ...
                <textarea  name="description" required id="description" class="form-control" placeholder="Enter Short Description" >@if( isset($prodCat) ){{ $prodCat->description }}@endif</textarea>
              </div> 
              </div>
