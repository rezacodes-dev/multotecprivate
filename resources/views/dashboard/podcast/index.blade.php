...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active">All Podcast</li>
  </ol>
</section>
@endsection
...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-6">
      <a href="{{ route('addPd') }}" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i> Create New
        Podcast</a>
    </div>
    <div class="col-md-6">
    </div>
  ...
  <div class="box" style="margin-top: 10px;">
    ...
    <form name="frmx" action="#" method="post">
      ...
      <div class="box-header with-border">
        <h3 class="box-title">All Podcasts</h3>
        <!-- Start -->
        ...
        <table class="table table-bordered table-hover table-striped display nowrap ar-datatable" style="width:100%; position:relative;">
          <thead>
            <tr>
              ...
              <th>Status</th>
              <th>Podcast Name</th>
              <!-- <th>Webinar Product(s)</th> 
            <th>Webinar Topic(s)</th>  -->
              <th>URL</th>
              <th>Hits by total</th>
              <th>Created</th>
              <th>Modified</th>
          ...
          <tbody id="webinar_body">
            ...
            <tr>
              ...
              <td>
                ...
                @php $url=route('editPd', array('id' => $pc->id)) @endphp

                <a href="{{ route('editPd', array('id' => $pc->id)) }}"><i class="fa fa-pencil-square-o fa-2x base-green"></i></a>
                {{-- <a href="{{ route('delPd', array('id' => $pc->id)) }}" onclick="return confirm('Sure To Delete This Item ?');"><i class="fa fa-2x fa-trash-o base-red"></i></a>
                <a title="View Attended Users" href="{{ route('viewPdUser', array('id' => $pc->id)) }}"><i class="fa fa-2x fa-eye base-green"></i></a> --}}

                 <a href="{{ url('en' . route('front.podcastContent', ['id' => $pc->slug], false)) }}" target="_blank">
              ...
              <td>
                @if($pc->status == '1')
                <a href="{{ route('acInac') }}?id={{ $pc->id }}&val=2&tab=podcast">
                  <i class="fa fa-check-circle-o base-green fa-2x" aria-hidden="true"></i>
                </a>
                @endif
                @if($pc->status == '2')
                <a href="{{ route('acInac') }}?id={{ $pc->id }}&val=1&tab=podcast">
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    $("#refresh").on('click', function() {
      ...
      let url = "{{route('ajaxRefreshWebinars')}}";
      $("#from_date").val('');
      $("#to_date").val('');
