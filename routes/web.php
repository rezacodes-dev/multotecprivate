...
Route::get('/en/current-events/{year}', function ($year) {
    abort(404);
})->name('currentEvents');
...
//	})->name('brochure');
	...
	Route::get('/location', 'FrontEndController@distributorMap')->name('front.distrbMap');
	Route::get('/distributor-map-filter', 'FrontEndController@distributorMapFilter')->name('front.distrbMapFilter');
	Route::get('/location/{catslug}', 'FrontEndController@distributorCategory')->name('front.distrbCat');
	
	Route::get('/location/{catslug?}/{distrbslug?}', 'FrontEndController@distributor')->name('front.distrb');
	Route::get('/multotec-chile', 'FrontEndController@distributorChile')->name('front.distrbCatChile');
	Route::get('/location/{catslug}/{distrbslug}/{contslug}', 'FrontEndController@distributorContent')->name('front.distrbCont');


	// Route::get('/location', 'FrontEndController@distributorMap')->name('front.distrbMap');
	// Route::get('/location-map-filter', 'FrontEndController@distributorMapFilter')->name('front.distrbMapFilter');
	// Route::get('/location/{catslug}', 'FrontEndController@distributorCategory')->name('front.distrbCat');
	// Route::get('/location/{catslug}/{distrbslug}', 'FrontEndController@distributor')->name('front.distrb');
	// Route::get('/location/{catslug}/{distrbslug}/{contslug}', 'FrontEndController@distributorContent')->name('front.distrbCont');
...
Route::group(['prefix' => '/en/admin'], function () {
	...
	/********** END DASHBOARD ACTION *********/
				...
				/*************** Brochure MANAGEMENT ******************/
				Route::group(['prefix' => 'brochure-language-management'], function() {
					Route::get('/', 'BrochureLanguageController@allBrochureIndustry')->name('allBrlgId');
					Route::get('/add', 'BrochureLanguageController@addBrochureIndustry')->name('addBrlgId');
					Route::post('/save', 'BrochureLanguageController@saveBrochureIndustry')->name('saveBrlgId');
					Route::get('/delete/{id}', 'BrochureLanguageController@deleteBrochureIndustry')->name('delBrlgId');
					Route::get('/edit/{id}', 'BrochureLanguageController@editBrochureIndustry')->name('editBrlgId');
					Route::post('/edit/{id}', 'BrochureLanguageController@editBrochureIndustry')->name('editBrlgId');
					Route::post('/update/{id}', 'BrochureLanguageController@updateBrochureIndustry')->name('updateBrlgId');
		
				});


				Route::group(['prefix' => 'brochure-product-management'], function() {
					Route::get('/', 'BrochureProductController@allBrochureProductIndustry')->name('allBrprId');
					Route::get('/add', 'BrochureProductController@addBrochureProduct')->name('addBrprId');
					Route::post('/save', 'BrochureProductController@saveBrochureProduct')->name('saveBrprId');
					Route::get('/delete/{id}', 'BrochureProductController@deleteBrochureProduct')->name('delBrprId');
					Route::get('/edit/{id}', 'BrochureProductController@editBrochureProduct')->name('editBrprId');
					Route::post('/edit/{id}', 'BrochureProductController@editBrochureProduct')->name('editBrprId');
					Route::post('/update/{id}', 'BrochureProductController@updateBrochureProduct')->name('updateBrprId');
		
				});


				Route::group(['prefix' => 'brochure-type-management'], function() {
					Route::get('/', 'BrochureTypeController@allBrochureIndustry')->name('allBrtyId');
					Route::get('/add', 'BrochureTypeController@addBrochureIndustry')->name('addBrtyId');
					Route::post('/save', 'BrochureTypeController@saveBrochureIndustry')->name('saveBrtyId');
					Route::get('/delete/{id}', 'BrochureTypeController@deleteBrochureIndustry')->name('delBrtyId');
					Route::get('/edit/{id}', 'BrochureTypeController@editBrochureIndustry')->name('editBrtyId');
					Route::post('/edit/{id}', 'BrochureTypeController@editBrochureIndustry')->name('editBrtyId');
					Route::post('/update/{id}', 'BrochureTypeController@updateBrochureIndustry')->name('updateBrtyId');
		
				});


				Route::group(['prefix' => 'brochure-brand-management'], function() {
					Route::get('/', 'BrochureBrandController@allBrochureIndustry')->name('allBrbrandId');
					Route::get('/add', 'BrochureBrandController@addBrochureIndustry')->name('addBrbrandId');
					Route::post('/save', 'BrochureBrandController@saveBrochureIndustry')->name('saveBrbrandId');
					Route::get('/delete/{id}', 'BrochureBrandController@deleteBrochureIndustry')->name('delBrbrandId');
					Route::get('/edit/{id}', 'BrochureBrandController@editBrochureIndustry')->name('editBrbrandId');
					Route::post('/edit/{id}', 'BrochureBrandController@editBrochureIndustry')->name('editBrbrandId');
					Route::post('/update/{id}', 'BrochureBrandController@updateBrochureIndustry')->name('updateBrbrandId');
		
				});

				Route::group(['prefix' => 'brochure-size-management'], function() {
					Route::get('/', 'BrochureSizeController@allBrochureIndustry')->name('allBrsiId');
					Route::get('/add', 'BrochureSizeController@addBrochureIndustry')->name('addBrsiId');
					Route::post('/save', 'BrochureSizeController@saveBrochureIndustry')->name('saveBrsiId');
					Route::get('/delete/{id}', 'BrochureSizeController@deleteBrochureIndustry')->name('delBrsiId');
					Route::get('/edit/{id}', 'BrochureSizeController@editBrochureIndustry')->name('editBrsiId');
					Route::post('/edit/{id}', 'BrochureSizeController@editBrochureIndustry')->name('editBrsiId');
					Route::post('/update/{id}', 'BrochureSizeController@updateBrochureIndustry')->name('updateBrsiId');
		
				});


				Route::group(['prefix' => 'all-brochure-management'], function() {
					Route::get('/', 'AllBrochureController@allBrochureIndustry')->name('allBrallId');
					Route::get('/add', 'AllBrochureController@addBrochureIndustry')->name('addBrallId');
					Route::post('/save', 'AllBrochureController@saveBrochureIndustry')->name('saveBrallId');
					Route::get('/delete/{id}', 'AllBrochureController@deleteBrochureIndustry')->name('delBrallId');
					Route::get('/edit/{id}', 'AllBrochureController@editBrochureIndustry')->name('editBrallId');
					Route::post('/edit/{id}', 'AllBrochureController@editBrochureIndustry')->name('editBrallId');
					Route::post('/update/{id}', 'AllBrochureController@updateBrochureIndustry')->name('updateBrallId');
					Route::get('/allBrochureContent', 'AllBrochureController@allBrochureContent')->name('allBrochureContent');
